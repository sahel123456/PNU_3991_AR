...
زمانی که برخی از شفافیت نسبت به مقاصد سیستم مبتنی بر وب بدست آمد, سوال پیش می‌آید که چه کسی و چگونه از سیستم استفاده خواهد شد.

از آنجا که سیستم‌های مبتنی بر وب سیستم‌های باز هستند, پیش‌بینی رفتار کاربران بسیار مهم است.

بنابراین, لازم است ابتدا ایده‌ای از کاربران مورد انتظار به دست آید.

البته, تمام این کاربران ممکن است مورد توجه ارائهدهنده سیستم نباشند, اما شناسایی آن دسته از کاربرانی که باید توسط سیستم پشتیبانی شوند, بسیار مهم است.

برای مثال, یک بانک ممکن است بخواهد یک سیستم مبتنی بر وب را برای سرمایه‌گذاری‌های مالی ارائه کند. در این صورت بانک به کاربرانی که قصد سرمایه‌گذاری و ارائه اطلاعات لازم را دارند, علاقمند است. هر کاربر دیگری از سیستم می‌تواند نادیده گرفته شود.

از آنجا که انتظار نمی‌رود که همه کاربران به همین روش عمل کنند, مشکل طبقه‌بندی کاربران مورد انتظار ایجاد می‌شود. این امر ممکن است منجر به پروفایل‌های خاص کاربر شود.

چنین پروفایل کاربری ممکن است با اهداف مختلف کاربران, مقاصد مختلف آن‌ها, رفتار متفاوت آن‌ها, نیازهای اطلاعاتی آن‌ها و سطوح پشتیبانی مورد نیاز آن‌ها تعیین شود.

بنابراین, فعالیت پروفایل کاربران منجر به فهرستی از پروفایل کاربران مورد انتظار می‌شود که توسط سیستم پشتیبانی می‌شوند.

این امر محتوای صفحات سایت, سازمان منطقی آن‌ها, لینک‌های جهت‌یابی فعال بین این صفحات و شاید حتی ارائه آن‌ها را تحت‌تاثیر قرار می‌دهد.

برای هر پروفایل کاربری باید پیش‌بینی کنیم که کاربران چگونه از سیستم عبور خواهند کرد.

اگر توالی احتمالی صفحات توسط داستان را نشان دهیم, مهم‌ترین مشکل تعیین این داستان‌ها و توصیف آن‌ها به شیوه‌ای انتزاعی و یکپارچه است.

ما به این مشکل اشاره می‌کنیم. شناسی زبان شناسان نشان‌دهنده پالایش بیشتر داستان‌ها از طریق داستان‌های کوتاه است که معمولاً مجموعه کوچکی از صحنه‌هایی را که شبیه به یک کلیپ از فیلم‌ها هستند, ضبط می‌کند.

برای مثال, ادامه مثال یک سیستم سرمایه‌گذاری, ممکن است کاربرانی داشته باشیم که نمی‌خواهند ریسک بزرگی داشته باشند در حالی که برخی دیگر مانند قماربازان رفتار می‌کنند.

داستان‌های مرتبط با این دو پروفایل کاملاً متفاوت خواهند بود, زیرا کاربران با مجموعه قبلی باید به فرصت‌های سرمایه‌گذاری با نرخ‌های بهره کمابیش ثابت هدایت شوند, در حالی که کاربران با پروفایل دومی احتمالاً در سهام و سهام سرمایه‌گذاری می‌کنند.
