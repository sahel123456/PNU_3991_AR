...
### Reading
  ...
  <tr>
    <th >
       <h2>1.2مشخصات سیستم های اطلاعات وب </h2>
 به یک سیستم اطلاعاتی که کاربران بتوانند از طریق مرورگرهای وب به آن دسترسی داشته باشند ، سیستم اطلاعات وب گفته می شود.چنین سیستم هایی توسط یک وب سایت ، یعنی مجموعه ای از صفحات وب ، تحقق پیدا میکنند.
</th>
  </tr>
   </table>
